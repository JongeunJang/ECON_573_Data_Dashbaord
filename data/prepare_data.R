...
# 3. Spatial Data: US Census Bureau Cartographic Boundary Files (via 'tigris' R package)
...
us_counties_shapefile <- tigris::counties(cb = TRUE, resolution = "20m", year = 2024)
